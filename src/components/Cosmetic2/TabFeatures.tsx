...
const TabFeatures: React.FC<Props> = ({ data, start, limit }) => {
    ...
    const getFilterData = () => {
        ...
        if (activeTab === 'on sale') {
            filtered = data.filter((product) => product.sale && (product.category === 'cosmetic'))
        } else if (activeTab === 'new arrivals') {
            filtered = data.filter((product) => product.new && (product.category === 'cosmetic'))
            ...
            filtered = data.filter((product) => product.category === 'cosmetic')
        }
