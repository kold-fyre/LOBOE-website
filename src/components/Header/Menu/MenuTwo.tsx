                ...
                <div className="container mx-auto h-full">
                    <div className="header-main flex justify-between h-full">
                        ...
                        <Link href={'/'} className='flex items-center'>
                            <div className="heading4"> LOBOE </div>
                        </Link>
                        ...
                        <div className="menu-main h-full max-lg:hidden">
                            <ul className='flex items-center gap-8 h-full'>
                                ...
                                <li className='h-full relative'>
                                    <Link href="/pages/about" className={`text-button-uppercase h-full flex items-center justify-center duration-300 ${pathname === '/pages/about' ? 'active' : ''}`}>
                                        About Us
                                    </Link>
                                </li>
                                <li className='h-full relative'>
                                    <Link href="/pages/contact" className={`text-button-uppercase h-full flex items-center justify-center duration-300 ${pathname === '/pages/contact' ? 'active' : ''}`}>
                                        Contact Us
                                    </Link>
                                </li>
                                <li className='h-full relative'>
                                    <Link href="/pages/store-list" className={`text-button-uppercase h-full flex items-center justify-center duration-300 ${pathname === '/pages/store-list' ? 'active' : ''}`}>
                                        Store List
                                    </Link>
                                </li>
                                {/* <li className='h-full relative'>
                                    <Link href="/pages/page-not-found" className={`text-button-uppercase h-full flex items-center justify-center duration-300 ${pathname === '/pages/page-not-found' ? 'active' : ''}`}>
                                        404
                                    </Link>
                                </li> */}
                                <li className='h-full relative'>
                                    <Link href="/pages/faqs" className={`text-button-uppercase h-full flex items-center justify-center duration-300 ${pathname === '/pages/faqs' ? 'active' : ''}`}>
                                        FAQs
                                    </Link>
                                </li>
                                {/* <li className='h-full relative'>
                                    <Link href="/pages/coming-soon" className={`text-button-uppercase h-full flex items-center justify-center duration-300 ${pathname === '/pages/coming-soon' ? 'active' : ''}`}>
                                        Coming Soon
                                    </Link>
                                </li> */}
                                {/* <li className='h-full relative'>
                                    <Link href="/pages/customer-feedbacks" className={`text-button-uppercase h-full flex items-center justify-center duration-300 ${pathname === '/pages/customer-feedbacks' ? 'active' : ''}`}>
                                        Customer Feedbacks
                                    </Link>
                                </li> */}
                            </ul>
                    ...
                    <div className="container h-full">
                        <div className="menu-main h-full overflow-hidden">
                            <div className="heading py-2 relative flex items-center justify-center">
                                ...
                                <Link href={'/'} className='logo text-3xl font-semibold text-center'>E-commerce</Link>
                            </div>
